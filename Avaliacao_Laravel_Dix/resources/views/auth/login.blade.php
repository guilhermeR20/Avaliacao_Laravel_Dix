...
@section('content')
    <div class="col-md-10 text-center ml-auto mr-auto">
        <h3 class="mb-5">Acesse aqui para checar as funções de CRUD de usúarios e postagem de noticias</h3>
    </div>
        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                <div class="card-header">
                    ...
                    <h1 class="card-title">{{ __('Bem vindo') }}</h1>
                </div>
                <div class="card-body">
                    <p class="text-dark mb-2">Utilize o email <strong>admin@white.com</strong> e a senha <strong>secret</strong> para acessar no modo admin</p>
                ...
                <div class="card-footer">
                    ...
                    <div class="pull-right">
                        <h6>
                            <a href="{{ route('password.request') }}" class="link footer-link">{{ __('Esqueceu senha?') }}</a>
                        </h6>
                    </div>
                </div>
            </div>
